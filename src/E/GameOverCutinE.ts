 ...
 *
 */
export interface GameOverCutinEParameterObject extends g.EParameterObject {
 ...
 *
 */
export class GameOverCutinE extends g.E {
	private messageImageSurface: g.Surface;

	constructor(param: GameOverCutinEParameterObject) {
		super(param);
